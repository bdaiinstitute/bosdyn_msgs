...
#ifndef BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_TO_ANCHOR_RESPONSE__TRAITS_HPP_
#define BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_TO_ANCHOR_RESPONSE__TRAITS_HPP_
...
// Member 'status'
#include "bosdyn_msgs/msg/detail/navigate_to_anchor_response_status__traits.hpp"
...
inline void to_flow_style_yaml(
  const NavigateToAnchorResponse & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
...
inline std::string to_yaml(const NavigateToAnchorResponse & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const bosdyn_msgs::msg::NavigateToAnchorResponse & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bosdyn_msgs::msg::NavigateToAnchorResponse & msg)
{
  return bosdyn_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<bosdyn_msgs::msg::NavigateToAnchorResponse>()
{
  return "bosdyn_msgs::msg::NavigateToAnchorResponse";
}

template<>
inline const char * name<bosdyn_msgs::msg::NavigateToAnchorResponse>()
{
  return "bosdyn_msgs/msg/NavigateToAnchorResponse";
}

template<>
struct has_fixed_size<bosdyn_msgs::msg::NavigateToAnchorResponse>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<bosdyn_msgs::msg::NavigateToAnchorResponse>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<bosdyn_msgs::msg::NavigateToAnchorResponse>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_TO_ANCHOR_RESPONSE__TRAITS_HPP_
