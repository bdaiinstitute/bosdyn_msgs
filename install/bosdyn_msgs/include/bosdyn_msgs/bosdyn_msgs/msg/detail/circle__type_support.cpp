...
{
  new (message_memory) bosdyn_msgs::msg::Circle(_init);
}

void Circle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bosdyn_msgs::msg::Circle *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Circle_message_member_array[3] = {
  {
    ...
    offsetof(bosdyn_msgs::msg::Circle, center_pt),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bosdyn_msgs::msg::Circle, center_pt_is_set),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bosdyn_msgs::msg::Circle, radius),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<bosdyn_msgs::msg::Circle>()
{
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::Circle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bosdyn_msgs, msg, Circle)() {
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::Circle_message_type_support_handle;
}
