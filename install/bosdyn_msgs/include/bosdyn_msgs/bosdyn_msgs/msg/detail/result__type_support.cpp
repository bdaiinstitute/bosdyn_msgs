...
{
  new (message_memory) bosdyn_msgs::msg::Result(_init);
}

void Result_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bosdyn_msgs::msg::Result *>(message_memory);
  typed_message->~Result();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Result_message_member_array[1] = {
  {
    "value",  // name
    ...
    offsetof(bosdyn_msgs::msg::Result, value),  // bytes offset in struct
...
get_message_type_support_handle<bosdyn_msgs::msg::Result>()
{
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::Result_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bosdyn_msgs, msg, Result)() {
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::Result_message_type_support_handle;
}
