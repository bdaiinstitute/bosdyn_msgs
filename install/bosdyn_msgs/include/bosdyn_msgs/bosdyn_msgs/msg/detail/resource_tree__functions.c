...
bosdyn_msgs__msg__ResourceTree__init(bosdyn_msgs__msg__ResourceTree * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->resource)) {
    bosdyn_msgs__msg__ResourceTree__fini(msg);
    return false;
  }
  // sub_resources
  if (!bosdyn_msgs__msg__SerializedMessage__Sequence__init(&msg->sub_resources, 0)) {
    bosdyn_msgs__msg__ResourceTree__fini(msg);
    return false;
  }
  return true;
...
bosdyn_msgs__msg__ResourceTree__fini(bosdyn_msgs__msg__ResourceTree * msg)
{
  ...
  // sub_resources
  bosdyn_msgs__msg__SerializedMessage__Sequence__fini(&msg->sub_resources);
}
...
bosdyn_msgs__msg__ResourceTree__are_equal(const bosdyn_msgs__msg__ResourceTree * lhs, const bosdyn_msgs__msg__ResourceTree * rhs)
{
  ...
  if (!bosdyn_msgs__msg__SerializedMessage__Sequence__are_equal(
      &(lhs->sub_resources), &(rhs->sub_resources)))
  {
    return false;
  }
  return true;
  ...
  bosdyn_msgs__msg__ResourceTree * output)
{
  ...
  if (!bosdyn_msgs__msg__SerializedMessage__Sequence__copy(
      &(input->sub_resources), &(output->sub_resources)))
  {
    return false;
  }
  return true;
...
bosdyn_msgs__msg__ResourceTree__create()
{
  ...
  bosdyn_msgs__msg__ResourceTree * msg = (bosdyn_msgs__msg__ResourceTree *)allocator.allocate(sizeof(bosdyn_msgs__msg__ResourceTree), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bosdyn_msgs__msg__ResourceTree));
  bool success = bosdyn_msgs__msg__ResourceTree__init(msg);
  if (!success) {
...
bosdyn_msgs__msg__ResourceTree__Sequence__init(bosdyn_msgs__msg__ResourceTree__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__ResourceTree * data = NULL;

  if (size) {
    data = (bosdyn_msgs__msg__ResourceTree *)allocator.zero_allocate(size, sizeof(bosdyn_msgs__msg__ResourceTree), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bosdyn_msgs__msg__ResourceTree__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bosdyn_msgs__msg__ResourceTree__fini(&data[i - 1]);
      }
...
bosdyn_msgs__msg__ResourceTree__Sequence__fini(bosdyn_msgs__msg__ResourceTree__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bosdyn_msgs__msg__ResourceTree__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__ResourceTree__Sequence * array = (bosdyn_msgs__msg__ResourceTree__Sequence *)allocator.allocate(sizeof(bosdyn_msgs__msg__ResourceTree__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bosdyn_msgs__msg__ResourceTree__Sequence__init(array, size);
  if (!success) {
...
bosdyn_msgs__msg__ResourceTree__Sequence__destroy(bosdyn_msgs__msg__ResourceTree__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bosdyn_msgs__msg__ResourceTree__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bosdyn_msgs__msg__ResourceTree__Sequence__are_equal(const bosdyn_msgs__msg__ResourceTree__Sequence * lhs, const bosdyn_msgs__msg__ResourceTree__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bosdyn_msgs__msg__ResourceTree__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bosdyn_msgs__msg__ResourceTree__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bosdyn_msgs__msg__ResourceTree);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bosdyn_msgs__msg__ResourceTree * data =
      (bosdyn_msgs__msg__ResourceTree *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bosdyn_msgs__msg__ResourceTree__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bosdyn_msgs__msg__ResourceTree__fini(&output->data[i]);
        }
        return false;
      }
    }
