...
#ifndef BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_ROUTE_RESPONSE__STRUCT_HPP_
#define BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_ROUTE_RESPONSE__STRUCT_HPP_
...
// Member 'status'
#include "bosdyn_msgs/msg/detail/navigate_route_response_status__struct.hpp"
...
#ifndef _WIN32
# define DEPRECATED__bosdyn_msgs__msg__NavigateRouteResponse __attribute__((deprecated))
#else
# define DEPRECATED__bosdyn_msgs__msg__NavigateRouteResponse __declspec(deprecated)
#endif
...
struct NavigateRouteResponse_
{
  using Type = NavigateRouteResponse_<ContainerAllocator>;

  explicit NavigateRouteResponse_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init),
    status(_init),
  ...
  explicit NavigateRouteResponse_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    status(_alloc, _init),
  ...
  _error_edge_ids_type error_edge_ids;
  ...
  Type & set__status(
    const bosdyn_msgs::msg::NavigateRouteResponseStatus_<ContainerAllocator> & _arg)
  {
    this->status = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    bosdyn_msgs::msg::NavigateRouteResponse_<ContainerAllocator> *;
  using ConstRawPtr =
    const bosdyn_msgs::msg::NavigateRouteResponse_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<bosdyn_msgs::msg::NavigateRouteResponse_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<bosdyn_msgs::msg::NavigateRouteResponse_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      bosdyn_msgs::msg::NavigateRouteResponse_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<bosdyn_msgs::msg::NavigateRouteResponse_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<bosdyn_msgs::msg::NavigateRouteResponse_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<bosdyn_msgs::msg::NavigateRouteResponse_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<bosdyn_msgs::msg::NavigateRouteResponse_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__bosdyn_msgs__msg__NavigateRouteResponse
    std::shared_ptr<bosdyn_msgs::msg::NavigateRouteResponse_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__bosdyn_msgs__msg__NavigateRouteResponse
    std::shared_ptr<bosdyn_msgs::msg::NavigateRouteResponse_<ContainerAllocator> const>
  ...
  bool operator==(const NavigateRouteResponse_ & other) const
  {
    ...
    if (this->error_edge_ids != other.error_edge_ids) {
      return false;
    }
...
using NavigateRouteResponse =
  bosdyn_msgs::msg::NavigateRouteResponse_<std::allocator<void>>;
...
#endif  // BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_ROUTE_RESPONSE__STRUCT_HPP_
