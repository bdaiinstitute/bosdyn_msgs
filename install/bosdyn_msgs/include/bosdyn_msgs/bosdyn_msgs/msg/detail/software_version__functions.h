...
#ifndef BOSDYN_MSGS__MSG__DETAIL__SOFTWARE_VERSION__FUNCTIONS_H_
#define BOSDYN_MSGS__MSG__DETAIL__SOFTWARE_VERSION__FUNCTIONS_H_
 ...
 * calls
 * bosdyn_msgs__msg__SoftwareVersion__init().
...
/**
 * It calls
 * bosdyn_msgs__msg__SoftwareVersion__fini()
 ...
 * bosdyn_msgs__msg__SoftwareVersion__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * bosdyn_msgs__msg__SoftwareVersion__Sequence__fini()
 * on the array,
...
#endif  // BOSDYN_MSGS__MSG__DETAIL__SOFTWARE_VERSION__FUNCTIONS_H_
