...
{
  new (message_memory) bosdyn_msgs::msg::Sound(_init);
}

void Sound_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bosdyn_msgs::msg::Sound *>(message_memory);
  typed_message->~Sound();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sound_message_member_array[1] = {
  {
    ...
    offsetof(bosdyn_msgs::msg::Sound, name),  // bytes offset in struct
...
get_message_type_support_handle<bosdyn_msgs::msg::Sound>()
{
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::Sound_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bosdyn_msgs, msg, Sound)() {
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::Sound_message_type_support_handle;
}
