...
#ifndef BOSDYN_MSGS__MSG__DETAIL__INT64_PARAM_SPEC__TRAITS_HPP_
#define BOSDYN_MSGS__MSG__DETAIL__INT64_PARAM_SPEC__TRAITS_HPP_
...
inline std::string to_yaml(const Int64ParamSpec & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const bosdyn_msgs::msg::Int64ParamSpec & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bosdyn_msgs::msg::Int64ParamSpec & msg)
{
  return bosdyn_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<bosdyn_msgs::msg::Int64ParamSpec>()
{
  return "bosdyn_msgs::msg::Int64ParamSpec";
}

template<>
inline const char * name<bosdyn_msgs::msg::Int64ParamSpec>()
{
  return "bosdyn_msgs/msg/Int64ParamSpec";
}

template<>
struct has_fixed_size<bosdyn_msgs::msg::Int64ParamSpec>
  : std::integral_constant<bool, has_fixed_size<bosdyn_msgs::msg::Units>::value> {};

template<>
struct has_bounded_size<bosdyn_msgs::msg::Int64ParamSpec>
  : std::integral_constant<bool, has_bounded_size<bosdyn_msgs::msg::Units>::value> {};

template<>
struct is_message<bosdyn_msgs::msg::Int64ParamSpec>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BOSDYN_MSGS__MSG__DETAIL__INT64_PARAM_SPEC__TRAITS_HPP_
