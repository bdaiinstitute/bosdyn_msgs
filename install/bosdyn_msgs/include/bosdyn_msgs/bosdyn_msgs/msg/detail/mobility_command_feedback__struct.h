...
#ifndef BOSDYN_MSGS__MSG__DETAIL__MOBILITY_COMMAND_FEEDBACK__STRUCT_H_
#define BOSDYN_MSGS__MSG__DETAIL__MOBILITY_COMMAND_FEEDBACK__STRUCT_H_
...
/// Struct defined in msg/MobilityCommandFeedback in the package bosdyn_msgs.
/**
  * AUTOMATICALLY GENERATED BY PROTO CONVERSION
 */
typedef struct bosdyn_msgs__msg__MobilityCommandFeedback
{
  ...
  bosdyn_msgs__msg__MobilityCommandFeedbackOneOfFeedback feedback;
  bosdyn_msgs__msg__RobotCommandFeedbackStatusStatus status;
} bosdyn_msgs__msg__MobilityCommandFeedback;

// Struct for a sequence of bosdyn_msgs__msg__MobilityCommandFeedback.
typedef struct bosdyn_msgs__msg__MobilityCommandFeedback__Sequence
{
...
#endif  // BOSDYN_MSGS__MSG__DETAIL__MOBILITY_COMMAND_FEEDBACK__STRUCT_H_
