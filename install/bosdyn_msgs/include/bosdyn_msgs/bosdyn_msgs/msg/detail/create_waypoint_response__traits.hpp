...
#ifndef BOSDYN_MSGS__MSG__DETAIL__CREATE_WAYPOINT_RESPONSE__TRAITS_HPP_
#define BOSDYN_MSGS__MSG__DETAIL__CREATE_WAYPOINT_RESPONSE__TRAITS_HPP_
...
// Member 'status'
#include "bosdyn_msgs/msg/detail/create_waypoint_response_status__traits.hpp"
...
inline void to_flow_style_yaml(
  const CreateWaypointResponse & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
  ...
  {
    out << "created_edge: ";
    to_flow_style_yaml(msg.created_edge, out);
    out << ", ";
  }

  // member: created_edge_is_set
  {
    out << "created_edge_is_set: ";
    rosidl_generator_traits::value_to_yaml(msg.created_edge_is_set, out);
    out << ", ";
  }
  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: created_edge
  {
    ...
    out << "created_edge:\n";
    to_block_style_yaml(msg.created_edge, out, indentation + 2);
  }
...
inline std::string to_yaml(const CreateWaypointResponse & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const bosdyn_msgs::msg::CreateWaypointResponse & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bosdyn_msgs::msg::CreateWaypointResponse & msg)
{
  return bosdyn_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<bosdyn_msgs::msg::CreateWaypointResponse>()
{
  return "bosdyn_msgs::msg::CreateWaypointResponse";
}

template<>
inline const char * name<bosdyn_msgs::msg::CreateWaypointResponse>()
{
  return "bosdyn_msgs/msg/CreateWaypointResponse";
}

template<>
struct has_fixed_size<bosdyn_msgs::msg::CreateWaypointResponse>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<bosdyn_msgs::msg::CreateWaypointResponse>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<bosdyn_msgs::msg::CreateWaypointResponse>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BOSDYN_MSGS__MSG__DETAIL__CREATE_WAYPOINT_RESPONSE__TRAITS_HPP_
