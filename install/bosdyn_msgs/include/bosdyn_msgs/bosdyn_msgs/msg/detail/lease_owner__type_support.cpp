...
{
  new (message_memory) bosdyn_msgs::msg::LeaseOwner(_init);
}

void LeaseOwner_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bosdyn_msgs::msg::LeaseOwner *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LeaseOwner_message_member_array[2] = {
  {
    ...
    offsetof(bosdyn_msgs::msg::LeaseOwner, client_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bosdyn_msgs::msg::LeaseOwner, user_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LeaseOwner_message_members = {
  ...
  2,  // number of fields
  sizeof(bosdyn_msgs::msg::LeaseOwner),
...
get_message_type_support_handle<bosdyn_msgs::msg::LeaseOwner>()
{
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::LeaseOwner_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bosdyn_msgs, msg, LeaseOwner)() {
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::LeaseOwner_message_type_support_handle;
}
