...
{
  new (message_memory) bosdyn_msgs::msg::BehaviorFaultState(_init);
}

void BehaviorFaultState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bosdyn_msgs::msg::BehaviorFaultState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BehaviorFaultState_message_member_array[1] = {
  {
    ...
    offsetof(bosdyn_msgs::msg::BehaviorFaultState, faults),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BehaviorFaultState_message_members = {
  ...
  1,  // number of fields
  sizeof(bosdyn_msgs::msg::BehaviorFaultState),
...
get_message_type_support_handle<bosdyn_msgs::msg::BehaviorFaultState>()
{
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::BehaviorFaultState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bosdyn_msgs, msg, BehaviorFaultState)() {
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::BehaviorFaultState_message_type_support_handle;
}
