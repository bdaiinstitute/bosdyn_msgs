...
bosdyn_msgs__msg__SeriesIdentifier__init(bosdyn_msgs__msg__SeriesIdentifier * msg)
{
  ...
  // series_type
  if (!rosidl_runtime_c__String__init(&msg->series_type)) {
    bosdyn_msgs__msg__SeriesIdentifier__fini(msg);
    return false;
  }
  // spec
  if (!bosdyn_msgs__msg__KeyStringValueString__Sequence__init(&msg->spec, 0)) {
    bosdyn_msgs__msg__SeriesIdentifier__fini(msg);
    return false;
  }
  return true;
...
bosdyn_msgs__msg__SeriesIdentifier__fini(bosdyn_msgs__msg__SeriesIdentifier * msg)
{
  ...
  // series_type
  rosidl_runtime_c__String__fini(&msg->series_type);
  // spec
  bosdyn_msgs__msg__KeyStringValueString__Sequence__fini(&msg->spec);
}
...
bosdyn_msgs__msg__SeriesIdentifier__are_equal(const bosdyn_msgs__msg__SeriesIdentifier * lhs, const bosdyn_msgs__msg__SeriesIdentifier * rhs)
{
  ...
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->series_type), &(rhs->series_type)))
  {
    return false;
  }
  // spec
  ...
  bosdyn_msgs__msg__SeriesIdentifier * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->series_type), &(output->series_type)))
  {
    return false;
  }
  // spec
...
bosdyn_msgs__msg__SeriesIdentifier__create()
{
  ...
  bosdyn_msgs__msg__SeriesIdentifier * msg = (bosdyn_msgs__msg__SeriesIdentifier *)allocator.allocate(sizeof(bosdyn_msgs__msg__SeriesIdentifier), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bosdyn_msgs__msg__SeriesIdentifier));
  bool success = bosdyn_msgs__msg__SeriesIdentifier__init(msg);
  if (!success) {
...
bosdyn_msgs__msg__SeriesIdentifier__Sequence__init(bosdyn_msgs__msg__SeriesIdentifier__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__SeriesIdentifier * data = NULL;

  if (size) {
    data = (bosdyn_msgs__msg__SeriesIdentifier *)allocator.zero_allocate(size, sizeof(bosdyn_msgs__msg__SeriesIdentifier), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bosdyn_msgs__msg__SeriesIdentifier__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bosdyn_msgs__msg__SeriesIdentifier__fini(&data[i - 1]);
      }
...
bosdyn_msgs__msg__SeriesIdentifier__Sequence__fini(bosdyn_msgs__msg__SeriesIdentifier__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bosdyn_msgs__msg__SeriesIdentifier__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__SeriesIdentifier__Sequence * array = (bosdyn_msgs__msg__SeriesIdentifier__Sequence *)allocator.allocate(sizeof(bosdyn_msgs__msg__SeriesIdentifier__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bosdyn_msgs__msg__SeriesIdentifier__Sequence__init(array, size);
  if (!success) {
...
bosdyn_msgs__msg__SeriesIdentifier__Sequence__destroy(bosdyn_msgs__msg__SeriesIdentifier__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bosdyn_msgs__msg__SeriesIdentifier__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bosdyn_msgs__msg__SeriesIdentifier__Sequence__are_equal(const bosdyn_msgs__msg__SeriesIdentifier__Sequence * lhs, const bosdyn_msgs__msg__SeriesIdentifier__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bosdyn_msgs__msg__SeriesIdentifier__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bosdyn_msgs__msg__SeriesIdentifier__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bosdyn_msgs__msg__SeriesIdentifier);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bosdyn_msgs__msg__SeriesIdentifier * data =
      (bosdyn_msgs__msg__SeriesIdentifier *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bosdyn_msgs__msg__SeriesIdentifier__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bosdyn_msgs__msg__SeriesIdentifier__fini(&output->data[i]);
        }
        return false;
      }
    }
