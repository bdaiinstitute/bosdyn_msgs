...
{
  new (message_memory) bosdyn_msgs::msg::TerrainState(_init);
}

void TerrainState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bosdyn_msgs::msg::TerrainState *>(message_memory);
  typed_message->~TerrainState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember TerrainState_message_member_array[1] = {
  {
    ...
    offsetof(bosdyn_msgs::msg::TerrainState, is_unsafe_to_sit),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TerrainState_message_members = {
  ...
  1,  // number of fields
  sizeof(bosdyn_msgs::msg::TerrainState),
...
get_message_type_support_handle<bosdyn_msgs::msg::TerrainState>()
{
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::TerrainState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bosdyn_msgs, msg, TerrainState)() {
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::TerrainState_message_type_support_handle;
}
