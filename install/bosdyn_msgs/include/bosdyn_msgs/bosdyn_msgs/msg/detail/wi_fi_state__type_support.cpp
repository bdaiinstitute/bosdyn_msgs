...
{
  new (message_memory) bosdyn_msgs::msg::WiFiState(_init);
}

void WiFiState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bosdyn_msgs::msg::WiFiState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WiFiState_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<bosdyn_msgs::msg::WiFiStateMode>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(bosdyn_msgs::msg::WiFiState, current_mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bosdyn_msgs::msg::WiFiState, essid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WiFiState_message_members = {
  ...
  2,  // number of fields
  sizeof(bosdyn_msgs::msg::WiFiState),
...
get_message_type_support_handle<bosdyn_msgs::msg::WiFiState>()
{
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::WiFiState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bosdyn_msgs, msg, WiFiState)() {
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::WiFiState_message_type_support_handle;
}
