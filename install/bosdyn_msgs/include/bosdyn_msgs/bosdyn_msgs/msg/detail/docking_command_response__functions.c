...
bosdyn_msgs__msg__DockingCommandResponse__init(bosdyn_msgs__msg__DockingCommandResponse * msg)
{
  ...
  if (!bosdyn_msgs__msg__ResponseHeader__init(&msg->header)) {
    bosdyn_msgs__msg__DockingCommandResponse__fini(msg);
    return false;
  }
  // header_is_set
  // lease_use_result
  ...
  // status
  if (!bosdyn_msgs__msg__DockingCommandResponseStatus__init(&msg->status)) {
    bosdyn_msgs__msg__DockingCommandResponse__fini(msg);
    return false;
  }
  // docking_command_id
...
bosdyn_msgs__msg__DockingCommandResponse__fini(bosdyn_msgs__msg__DockingCommandResponse * msg)
{
  ...
  // lease_use_result_is_set
  // status
  bosdyn_msgs__msg__DockingCommandResponseStatus__fini(&msg->status);
  // docking_command_id
}
...
bosdyn_msgs__msg__DockingCommandResponse__are_equal(const bosdyn_msgs__msg__DockingCommandResponse * lhs, const bosdyn_msgs__msg__DockingCommandResponse * rhs)
{
  ...
  // status
  if (!bosdyn_msgs__msg__DockingCommandResponseStatus__are_equal(
...
bosdyn_msgs__msg__DockingCommandResponse__create()
{
  ...
  bosdyn_msgs__msg__DockingCommandResponse * msg = (bosdyn_msgs__msg__DockingCommandResponse *)allocator.allocate(sizeof(bosdyn_msgs__msg__DockingCommandResponse), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bosdyn_msgs__msg__DockingCommandResponse));
  bool success = bosdyn_msgs__msg__DockingCommandResponse__init(msg);
  if (!success) {
...
bosdyn_msgs__msg__DockingCommandResponse__Sequence__init(bosdyn_msgs__msg__DockingCommandResponse__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__DockingCommandResponse * data = NULL;

  if (size) {
    data = (bosdyn_msgs__msg__DockingCommandResponse *)allocator.zero_allocate(size, sizeof(bosdyn_msgs__msg__DockingCommandResponse), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bosdyn_msgs__msg__DockingCommandResponse__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bosdyn_msgs__msg__DockingCommandResponse__fini(&data[i - 1]);
      }
...
bosdyn_msgs__msg__DockingCommandResponse__Sequence__fini(bosdyn_msgs__msg__DockingCommandResponse__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bosdyn_msgs__msg__DockingCommandResponse__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__DockingCommandResponse__Sequence * array = (bosdyn_msgs__msg__DockingCommandResponse__Sequence *)allocator.allocate(sizeof(bosdyn_msgs__msg__DockingCommandResponse__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bosdyn_msgs__msg__DockingCommandResponse__Sequence__init(array, size);
  if (!success) {
...
bosdyn_msgs__msg__DockingCommandResponse__Sequence__destroy(bosdyn_msgs__msg__DockingCommandResponse__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bosdyn_msgs__msg__DockingCommandResponse__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bosdyn_msgs__msg__DockingCommandResponse__Sequence__are_equal(const bosdyn_msgs__msg__DockingCommandResponse__Sequence * lhs, const bosdyn_msgs__msg__DockingCommandResponse__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bosdyn_msgs__msg__DockingCommandResponse__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bosdyn_msgs__msg__DockingCommandResponse__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bosdyn_msgs__msg__DockingCommandResponse);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bosdyn_msgs__msg__DockingCommandResponse * data =
      (bosdyn_msgs__msg__DockingCommandResponse *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bosdyn_msgs__msg__DockingCommandResponse__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bosdyn_msgs__msg__DockingCommandResponse__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!bosdyn_msgs__msg__DockingCommandResponse__copy(
