...
{
  new (message_memory) bosdyn_msgs::msg::RobotCommand(_init);
}

void RobotCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bosdyn_msgs::msg::RobotCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotCommand_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<bosdyn_msgs::msg::RobotCommandOneOfCommand>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(bosdyn_msgs::msg::RobotCommand, command),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotCommand_message_members = {
  ...
  1,  // number of fields
  sizeof(bosdyn_msgs::msg::RobotCommand),
...
get_message_type_support_handle<bosdyn_msgs::msg::RobotCommand>()
{
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::RobotCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bosdyn_msgs, msg, RobotCommand)() {
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::RobotCommand_message_type_support_handle;
}
