...
{
  new (message_memory) bosdyn_msgs::msg::SystemFaultState(_init);
}

void SystemFaultState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bosdyn_msgs::msg::SystemFaultState *>(message_memory);
...
size_t size_function__SystemFaultState__aggregated(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<bosdyn_msgs::msg::KeyStringValueBosdynMsgsSystemFaultSeverity> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SystemFaultState__aggregated(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<bosdyn_msgs::msg::KeyStringValueBosdynMsgsSystemFaultSeverity> *>(untyped_member);
  return &member[index];
}

void * get_function__SystemFaultState__aggregated(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<bosdyn_msgs::msg::KeyStringValueBosdynMsgsSystemFaultSeverity> *>(untyped_member);
  return &member[index];
}

void fetch_function__SystemFaultState__aggregated(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const bosdyn_msgs::msg::KeyStringValueBosdynMsgsSystemFaultSeverity *>(
    get_const_function__SystemFaultState__aggregated(untyped_member, index));
  auto & value = *reinterpret_cast<bosdyn_msgs::msg::KeyStringValueBosdynMsgsSystemFaultSeverity *>(untyped_value);
  value = item;
}

void assign_function__SystemFaultState__aggregated(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<bosdyn_msgs::msg::KeyStringValueBosdynMsgsSystemFaultSeverity *>(
    get_function__SystemFaultState__aggregated(untyped_member, index));
  const auto & value = *reinterpret_cast<const bosdyn_msgs::msg::KeyStringValueBosdynMsgsSystemFaultSeverity *>(untyped_value);
  item = value;
}

void resize_function__SystemFaultState__aggregated(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<bosdyn_msgs::msg::KeyStringValueBosdynMsgsSystemFaultSeverity> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SystemFaultState_message_member_array[3] = {
  {
    "faults",  // name
    ...
    offsetof(bosdyn_msgs::msg::SystemFaultState, faults),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bosdyn_msgs::msg::SystemFaultState, historical_faults),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<bosdyn_msgs::msg::KeyStringValueBosdynMsgsSystemFaultSeverity>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(bosdyn_msgs::msg::SystemFaultState, aggregated),  // bytes offset in struct
    nullptr,  // default value
    size_function__SystemFaultState__aggregated,  // size() function pointer
    get_const_function__SystemFaultState__aggregated,  // get_const(index) function pointer
    get_function__SystemFaultState__aggregated,  // get(index) function pointer
    fetch_function__SystemFaultState__aggregated,  // fetch(index, &value) function pointer
    assign_function__SystemFaultState__aggregated,  // assign(index, value) function pointer
    resize_function__SystemFaultState__aggregated  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SystemFaultState_message_members = {
  ...
  3,  // number of fields
  sizeof(bosdyn_msgs::msg::SystemFaultState),
...
get_message_type_support_handle<bosdyn_msgs::msg::SystemFaultState>()
{
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::SystemFaultState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bosdyn_msgs, msg, SystemFaultState)() {
  return &::bosdyn_msgs::msg::rosidl_typesupport_introspection_cpp::SystemFaultState_message_type_support_handle;
}
