...
#ifndef BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_TO_RESPONSE__STRUCT_HPP_
#define BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_TO_RESPONSE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__bosdyn_msgs__msg__NavigateToResponse __attribute__((deprecated))
#else
# define DEPRECATED__bosdyn_msgs__msg__NavigateToResponse __declspec(deprecated)
#endif
...
struct NavigateToResponse_
{
  using Type = NavigateToResponse_<ContainerAllocator>;

  explicit NavigateToResponse_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init),
    status(_init),
  ...
  explicit NavigateToResponse_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    status(_alloc, _init),
  ...
  Type & set__status(
    const bosdyn_msgs::msg::NavigateToResponseStatus_<ContainerAllocator> & _arg)
  {
    this->status = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    bosdyn_msgs::msg::NavigateToResponse_<ContainerAllocator> *;
  using ConstRawPtr =
    const bosdyn_msgs::msg::NavigateToResponse_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<bosdyn_msgs::msg::NavigateToResponse_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<bosdyn_msgs::msg::NavigateToResponse_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      bosdyn_msgs::msg::NavigateToResponse_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<bosdyn_msgs::msg::NavigateToResponse_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<bosdyn_msgs::msg::NavigateToResponse_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<bosdyn_msgs::msg::NavigateToResponse_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<bosdyn_msgs::msg::NavigateToResponse_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__bosdyn_msgs__msg__NavigateToResponse
    std::shared_ptr<bosdyn_msgs::msg::NavigateToResponse_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__bosdyn_msgs__msg__NavigateToResponse
    std::shared_ptr<bosdyn_msgs::msg::NavigateToResponse_<ContainerAllocator> const>
  ...
  bool operator==(const NavigateToResponse_ & other) const
  {
...
using NavigateToResponse =
  bosdyn_msgs::msg::NavigateToResponse_<std::allocator<void>>;
...
#endif  // BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_TO_RESPONSE__STRUCT_HPP_
