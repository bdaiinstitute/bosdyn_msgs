...
bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__init(bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool * msg)
{
  ...
  // body_tform_tool
  if (!geometry_msgs__msg__Pose__init(&msg->body_tform_tool)) {
    bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__fini(msg);
    return false;
  }
  // body_tform_tool_is_set
  return true;
}
...
bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__fini(bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool * msg)
{
  ...
  // body_tform_tool
  geometry_msgs__msg__Pose__fini(&msg->body_tform_tool);
  // body_tform_tool_is_set
}
...
bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__are_equal(const bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool * lhs, const bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool * rhs)
{
  ...
  if (!geometry_msgs__msg__Pose__are_equal(
      &(lhs->body_tform_tool), &(rhs->body_tform_tool)))
  {
    return false;
  }
  // body_tform_tool_is_set
  if (lhs->body_tform_tool_is_set != rhs->body_tform_tool_is_set) {
    return false;
  }
  return true;
}
  ...
  bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool * output)
{
  ...
  if (!geometry_msgs__msg__Pose__copy(
      &(input->body_tform_tool), &(output->body_tform_tool)))
  {
    return false;
  }
  // body_tform_tool_is_set
  output->body_tform_tool_is_set = input->body_tform_tool_is_set;
  return true;
}
...
bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__create()
{
  ...
  bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool * msg = (bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool *)allocator.allocate(sizeof(bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool));
  bool success = bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__init(msg);
  if (!success) {
...
bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence__init(bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool * data = NULL;

  if (size) {
    data = (bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool *)allocator.zero_allocate(size, sizeof(bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__fini(&data[i - 1]);
      }
...
bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence__fini(bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence * array = (bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence *)allocator.allocate(sizeof(bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence__init(array, size);
  if (!success) {
...
bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence__destroy(bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence__are_equal(const bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence * lhs, const bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool * data =
      (bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bosdyn_msgs__msg__InverseKinematicsRequestBodyMountedTool__fini(&output->data[i]);
        }
        return false;
      }
    }
