...
bosdyn_msgs__msg__BoundingBoxProperties__init(bosdyn_msgs__msg__BoundingBoxProperties * msg)
{
  ...
  // size_ewrt_frame
  if (!geometry_msgs__msg__Vector3__init(&msg->size_ewrt_frame)) {
    bosdyn_msgs__msg__BoundingBoxProperties__fini(msg);
    return false;
  }
  // size_ewrt_frame_is_set
  // frame
...
bosdyn_msgs__msg__BoundingBoxProperties__fini(bosdyn_msgs__msg__BoundingBoxProperties * msg)
{
  ...
  // size_ewrt_frame
  geometry_msgs__msg__Vector3__fini(&msg->size_ewrt_frame);
  // size_ewrt_frame_is_set
  // frame
...
bosdyn_msgs__msg__BoundingBoxProperties__are_equal(const bosdyn_msgs__msg__BoundingBoxProperties * lhs, const bosdyn_msgs__msg__BoundingBoxProperties * rhs)
{
  ...
  if (!geometry_msgs__msg__Vector3__are_equal(
      &(lhs->size_ewrt_frame), &(rhs->size_ewrt_frame)))
  {
    return false;
  }
  // size_ewrt_frame_is_set
  if (lhs->size_ewrt_frame_is_set != rhs->size_ewrt_frame_is_set) {
    return false;
  }
  // frame
  ...
  bosdyn_msgs__msg__BoundingBoxProperties * output)
{
  ...
  if (!geometry_msgs__msg__Vector3__copy(
      &(input->size_ewrt_frame), &(output->size_ewrt_frame)))
  {
    return false;
  }
  // size_ewrt_frame_is_set
  output->size_ewrt_frame_is_set = input->size_ewrt_frame_is_set;
  // frame
...
bosdyn_msgs__msg__BoundingBoxProperties__create()
{
  ...
  bosdyn_msgs__msg__BoundingBoxProperties * msg = (bosdyn_msgs__msg__BoundingBoxProperties *)allocator.allocate(sizeof(bosdyn_msgs__msg__BoundingBoxProperties), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bosdyn_msgs__msg__BoundingBoxProperties));
  bool success = bosdyn_msgs__msg__BoundingBoxProperties__init(msg);
  if (!success) {
...
bosdyn_msgs__msg__BoundingBoxProperties__Sequence__init(bosdyn_msgs__msg__BoundingBoxProperties__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__BoundingBoxProperties * data = NULL;

  if (size) {
    data = (bosdyn_msgs__msg__BoundingBoxProperties *)allocator.zero_allocate(size, sizeof(bosdyn_msgs__msg__BoundingBoxProperties), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bosdyn_msgs__msg__BoundingBoxProperties__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bosdyn_msgs__msg__BoundingBoxProperties__fini(&data[i - 1]);
      }
...
bosdyn_msgs__msg__BoundingBoxProperties__Sequence__fini(bosdyn_msgs__msg__BoundingBoxProperties__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bosdyn_msgs__msg__BoundingBoxProperties__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__BoundingBoxProperties__Sequence * array = (bosdyn_msgs__msg__BoundingBoxProperties__Sequence *)allocator.allocate(sizeof(bosdyn_msgs__msg__BoundingBoxProperties__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bosdyn_msgs__msg__BoundingBoxProperties__Sequence__init(array, size);
  if (!success) {
...
bosdyn_msgs__msg__BoundingBoxProperties__Sequence__destroy(bosdyn_msgs__msg__BoundingBoxProperties__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bosdyn_msgs__msg__BoundingBoxProperties__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bosdyn_msgs__msg__BoundingBoxProperties__Sequence__are_equal(const bosdyn_msgs__msg__BoundingBoxProperties__Sequence * lhs, const bosdyn_msgs__msg__BoundingBoxProperties__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bosdyn_msgs__msg__BoundingBoxProperties__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bosdyn_msgs__msg__BoundingBoxProperties__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bosdyn_msgs__msg__BoundingBoxProperties);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bosdyn_msgs__msg__BoundingBoxProperties * data =
      (bosdyn_msgs__msg__BoundingBoxProperties *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bosdyn_msgs__msg__BoundingBoxProperties__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bosdyn_msgs__msg__BoundingBoxProperties__fini(&output->data[i]);
        }
        return false;
      }
    }
