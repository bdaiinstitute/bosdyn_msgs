...
#ifndef BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_ROUTE_REQUEST__TRAITS_HPP_
#define BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_ROUTE_REQUEST__TRAITS_HPP_
...
inline void to_flow_style_yaml(
  const NavigateRouteRequest & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
...
inline std::string to_yaml(const NavigateRouteRequest & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const bosdyn_msgs::msg::NavigateRouteRequest & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bosdyn_msgs::msg::NavigateRouteRequest & msg)
{
  return bosdyn_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<bosdyn_msgs::msg::NavigateRouteRequest>()
{
  return "bosdyn_msgs::msg::NavigateRouteRequest";
}

template<>
inline const char * name<bosdyn_msgs::msg::NavigateRouteRequest>()
{
  return "bosdyn_msgs/msg/NavigateRouteRequest";
}

template<>
struct has_fixed_size<bosdyn_msgs::msg::NavigateRouteRequest>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<bosdyn_msgs::msg::NavigateRouteRequest>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<bosdyn_msgs::msg::NavigateRouteRequest>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_ROUTE_REQUEST__TRAITS_HPP_
