...
#ifndef BOSDYN_MSGS__MSG__DETAIL__UPDATE_EXPERIMENT_LOG_RESPONSE__STRUCT_H_
#define BOSDYN_MSGS__MSG__DETAIL__UPDATE_EXPERIMENT_LOG_RESPONSE__STRUCT_H_
...
/// Struct defined in msg/UpdateExperimentLogResponse in the package bosdyn_msgs.
/**
  * AUTOMATICALLY GENERATED BY PROTO CONVERSION
 */
typedef struct bosdyn_msgs__msg__UpdateExperimentLogResponse
{
  /// Common response header.
  bosdyn_msgs__msg__ResponseHeader header;
  bool header_is_set;
  /// Response status.
  bosdyn_msgs__msg__UpdateExperimentLogResponseStatus status;
...
// Struct for a sequence of bosdyn_msgs__msg__UpdateExperimentLogResponse.
typedef struct bosdyn_msgs__msg__UpdateExperimentLogResponse__Sequence
{
...
#endif  // BOSDYN_MSGS__MSG__DETAIL__UPDATE_EXPERIMENT_LOG_RESPONSE__STRUCT_H_
