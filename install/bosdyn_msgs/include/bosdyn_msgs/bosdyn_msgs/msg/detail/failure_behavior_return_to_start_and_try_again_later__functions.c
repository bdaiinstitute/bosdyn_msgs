...
bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__init(bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater * msg)
{
  ...
  // try_again_delay
  if (!builtin_interfaces__msg__Duration__init(&msg->try_again_delay)) {
    bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__fini(msg);
    return false;
  }
  // try_again_delay_is_set
  return true;
}
...
bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__fini(bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater * msg)
{
  ...
  // try_again_delay
  builtin_interfaces__msg__Duration__fini(&msg->try_again_delay);
  // try_again_delay_is_set
}
...
bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__are_equal(const bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater * lhs, const bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater * rhs)
{
  ...
  if (!builtin_interfaces__msg__Duration__are_equal(
      &(lhs->try_again_delay), &(rhs->try_again_delay)))
  {
    return false;
  }
  // try_again_delay_is_set
  if (lhs->try_again_delay_is_set != rhs->try_again_delay_is_set) {
    return false;
  }
  return true;
}
  ...
  bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater * output)
{
  ...
  if (!builtin_interfaces__msg__Duration__copy(
      &(input->try_again_delay), &(output->try_again_delay)))
  {
    return false;
  }
  // try_again_delay_is_set
  output->try_again_delay_is_set = input->try_again_delay_is_set;
  return true;
}
...
bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__create()
{
  ...
  bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater * msg = (bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater *)allocator.allocate(sizeof(bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater));
  bool success = bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__init(msg);
  if (!success) {
...
bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence__init(bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater * data = NULL;

  if (size) {
    data = (bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater *)allocator.zero_allocate(size, sizeof(bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__fini(&data[i - 1]);
      }
...
bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence__fini(bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence * array = (bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence *)allocator.allocate(sizeof(bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence__init(array, size);
  if (!success) {
...
bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence__destroy(bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence__are_equal(const bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence * lhs, const bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater * data =
      (bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bosdyn_msgs__msg__FailureBehaviorReturnToStartAndTryAgainLater__fini(&output->data[i]);
        }
        return false;
      }
    }
