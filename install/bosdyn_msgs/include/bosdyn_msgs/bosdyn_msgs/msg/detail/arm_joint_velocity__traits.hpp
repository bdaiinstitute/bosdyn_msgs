...
#ifndef BOSDYN_MSGS__MSG__DETAIL__ARM_JOINT_VELOCITY__TRAITS_HPP_
#define BOSDYN_MSGS__MSG__DETAIL__ARM_JOINT_VELOCITY__TRAITS_HPP_
...
inline std::string to_yaml(const ArmJointVelocity & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const bosdyn_msgs::msg::ArmJointVelocity & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bosdyn_msgs::msg::ArmJointVelocity & msg)
{
  return bosdyn_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<bosdyn_msgs::msg::ArmJointVelocity>()
{
  return "bosdyn_msgs::msg::ArmJointVelocity";
}

template<>
inline const char * name<bosdyn_msgs::msg::ArmJointVelocity>()
{
  return "bosdyn_msgs/msg/ArmJointVelocity";
}

template<>
struct has_fixed_size<bosdyn_msgs::msg::ArmJointVelocity>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<bosdyn_msgs::msg::ArmJointVelocity>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<bosdyn_msgs::msg::ArmJointVelocity>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BOSDYN_MSGS__MSG__DETAIL__ARM_JOINT_VELOCITY__TRAITS_HPP_
