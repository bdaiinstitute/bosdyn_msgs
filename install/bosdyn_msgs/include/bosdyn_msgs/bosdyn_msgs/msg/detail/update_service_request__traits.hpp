...
#ifndef BOSDYN_MSGS__MSG__DETAIL__UPDATE_SERVICE_REQUEST__TRAITS_HPP_
#define BOSDYN_MSGS__MSG__DETAIL__UPDATE_SERVICE_REQUEST__TRAITS_HPP_
...
inline void to_flow_style_yaml(
  const UpdateServiceRequest & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
...
inline std::string to_yaml(const UpdateServiceRequest & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const bosdyn_msgs::msg::UpdateServiceRequest & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bosdyn_msgs::msg::UpdateServiceRequest & msg)
{
  return bosdyn_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<bosdyn_msgs::msg::UpdateServiceRequest>()
{
  return "bosdyn_msgs::msg::UpdateServiceRequest";
}

template<>
inline const char * name<bosdyn_msgs::msg::UpdateServiceRequest>()
{
  return "bosdyn_msgs/msg/UpdateServiceRequest";
}

template<>
struct has_fixed_size<bosdyn_msgs::msg::UpdateServiceRequest>
...
template<>
struct has_bounded_size<bosdyn_msgs::msg::UpdateServiceRequest>
...
template<>
struct is_message<bosdyn_msgs::msg::UpdateServiceRequest>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BOSDYN_MSGS__MSG__DETAIL__UPDATE_SERVICE_REQUEST__TRAITS_HPP_
