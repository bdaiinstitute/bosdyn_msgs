...
#ifndef BOSDYN_MSGS__MSG__DETAIL__BEHAVIOR_FAULT_STATE__STRUCT_HPP_
#define BOSDYN_MSGS__MSG__DETAIL__BEHAVIOR_FAULT_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__bosdyn_msgs__msg__BehaviorFaultState __attribute__((deprecated))
#else
# define DEPRECATED__bosdyn_msgs__msg__BehaviorFaultState __declspec(deprecated)
#endif
...
struct BehaviorFaultState_
{
  ...
  using ConstRawPtr =
    const bosdyn_msgs::msg::BehaviorFaultState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<bosdyn_msgs::msg::BehaviorFaultState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<bosdyn_msgs::msg::BehaviorFaultState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      bosdyn_msgs::msg::BehaviorFaultState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<bosdyn_msgs::msg::BehaviorFaultState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<bosdyn_msgs::msg::BehaviorFaultState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<bosdyn_msgs::msg::BehaviorFaultState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<bosdyn_msgs::msg::BehaviorFaultState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__bosdyn_msgs__msg__BehaviorFaultState
    std::shared_ptr<bosdyn_msgs::msg::BehaviorFaultState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__bosdyn_msgs__msg__BehaviorFaultState
    std::shared_ptr<bosdyn_msgs::msg::BehaviorFaultState_<ContainerAllocator> const>
...
using BehaviorFaultState =
  bosdyn_msgs::msg::BehaviorFaultState_<std::allocator<void>>;
...
#endif  // BOSDYN_MSGS__MSG__DETAIL__BEHAVIOR_FAULT_STATE__STRUCT_HPP_
