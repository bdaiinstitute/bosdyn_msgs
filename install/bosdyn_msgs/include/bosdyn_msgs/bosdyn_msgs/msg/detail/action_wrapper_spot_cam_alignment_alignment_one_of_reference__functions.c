...
bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__init(bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference * msg)
{
  ...
  // scene_object_id
  if (!rosidl_runtime_c__String__init(&msg->scene_object_id)) {
    bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__fini(msg);
    return false;
  }
  // reference_choice
  return true;
...
bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__fini(bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference * msg)
{
  ...
  // scene_object_id
  rosidl_runtime_c__String__fini(&msg->scene_object_id);
  // reference_choice
}
...
bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__are_equal(const bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference * lhs, const bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference * rhs)
{
  ...
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->scene_object_id), &(rhs->scene_object_id)))
  {
    return false;
  }
  // reference_choice
  if (lhs->reference_choice != rhs->reference_choice) {
    return false;
  }
  return true;
}
  ...
  bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->scene_object_id), &(output->scene_object_id)))
  {
    return false;
  }
  // reference_choice
  output->reference_choice = input->reference_choice;
  return true;
}
...
bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__create()
{
  ...
  bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference * msg = (bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference *)allocator.allocate(sizeof(bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference));
  bool success = bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__init(msg);
  if (!success) {
...
bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence__init(bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference * data = NULL;

  if (size) {
    data = (bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference *)allocator.zero_allocate(size, sizeof(bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__fini(&data[i - 1]);
      }
...
bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence__fini(bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence * array = (bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence *)allocator.allocate(sizeof(bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence__init(array, size);
  if (!success) {
...
bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence__destroy(bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence__are_equal(const bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence * lhs, const bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference * data =
      (bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bosdyn_msgs__msg__ActionWrapperSpotCamAlignmentAlignmentOneOfReference__fini(&output->data[i]);
        }
        return false;
      }
    }
