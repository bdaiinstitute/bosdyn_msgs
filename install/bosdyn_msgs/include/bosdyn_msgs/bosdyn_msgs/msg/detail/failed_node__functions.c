...
bosdyn_msgs__msg__FailedNode__init(bosdyn_msgs__msg__FailedNode * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    bosdyn_msgs__msg__FailedNode__fini(msg);
    return false;
  }
  // error
  ...
  // impl_typename
  if (!rosidl_runtime_c__String__init(&msg->impl_typename)) {
    bosdyn_msgs__msg__FailedNode__fini(msg);
    return false;
  }
  return true;
...
bosdyn_msgs__msg__FailedNode__fini(bosdyn_msgs__msg__FailedNode * msg)
{
  ...
  // impl_typename
  rosidl_runtime_c__String__fini(&msg->impl_typename);
}
...
bosdyn_msgs__msg__FailedNode__are_equal(const bosdyn_msgs__msg__FailedNode * lhs, const bosdyn_msgs__msg__FailedNode * rhs)
{
  ...
  // impl_typename
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->impl_typename), &(rhs->impl_typename)))
  {
    return false;
  }
  return true;
  ...
  bosdyn_msgs__msg__FailedNode * output)
{
  ...
  // impl_typename
  if (!rosidl_runtime_c__String__copy(
      &(input->impl_typename), &(output->impl_typename)))
  {
    return false;
  }
  return true;
...
bosdyn_msgs__msg__FailedNode__create()
{
  ...
  bosdyn_msgs__msg__FailedNode * msg = (bosdyn_msgs__msg__FailedNode *)allocator.allocate(sizeof(bosdyn_msgs__msg__FailedNode), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bosdyn_msgs__msg__FailedNode));
  bool success = bosdyn_msgs__msg__FailedNode__init(msg);
  if (!success) {
...
bosdyn_msgs__msg__FailedNode__Sequence__init(bosdyn_msgs__msg__FailedNode__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__FailedNode * data = NULL;

  if (size) {
    data = (bosdyn_msgs__msg__FailedNode *)allocator.zero_allocate(size, sizeof(bosdyn_msgs__msg__FailedNode), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bosdyn_msgs__msg__FailedNode__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bosdyn_msgs__msg__FailedNode__fini(&data[i - 1]);
      }
...
bosdyn_msgs__msg__FailedNode__Sequence__fini(bosdyn_msgs__msg__FailedNode__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bosdyn_msgs__msg__FailedNode__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__FailedNode__Sequence * array = (bosdyn_msgs__msg__FailedNode__Sequence *)allocator.allocate(sizeof(bosdyn_msgs__msg__FailedNode__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bosdyn_msgs__msg__FailedNode__Sequence__init(array, size);
  if (!success) {
...
bosdyn_msgs__msg__FailedNode__Sequence__destroy(bosdyn_msgs__msg__FailedNode__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bosdyn_msgs__msg__FailedNode__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bosdyn_msgs__msg__FailedNode__Sequence__are_equal(const bosdyn_msgs__msg__FailedNode__Sequence * lhs, const bosdyn_msgs__msg__FailedNode__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bosdyn_msgs__msg__FailedNode__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bosdyn_msgs__msg__FailedNode__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bosdyn_msgs__msg__FailedNode);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bosdyn_msgs__msg__FailedNode * data =
      (bosdyn_msgs__msg__FailedNode *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bosdyn_msgs__msg__FailedNode__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bosdyn_msgs__msg__FailedNode__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!bosdyn_msgs__msg__FailedNode__copy(
