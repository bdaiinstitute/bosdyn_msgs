...
#ifndef BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_TO_RESPONSE__TRAITS_HPP_
#define BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_TO_RESPONSE__TRAITS_HPP_
...
// Member 'status'
#include "bosdyn_msgs/msg/detail/navigate_to_response_status__traits.hpp"
...
inline std::string to_yaml(const NavigateToResponse & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const bosdyn_msgs::msg::NavigateToResponse & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bosdyn_msgs::msg::NavigateToResponse & msg)
{
  return bosdyn_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<bosdyn_msgs::msg::NavigateToResponse>()
{
  return "bosdyn_msgs::msg::NavigateToResponse";
}

template<>
inline const char * name<bosdyn_msgs::msg::NavigateToResponse>()
{
  return "bosdyn_msgs/msg/NavigateToResponse";
}

template<>
struct has_fixed_size<bosdyn_msgs::msg::NavigateToResponse>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<bosdyn_msgs::msg::NavigateToResponse>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<bosdyn_msgs::msg::NavigateToResponse>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BOSDYN_MSGS__MSG__DETAIL__NAVIGATE_TO_RESPONSE__TRAITS_HPP_
