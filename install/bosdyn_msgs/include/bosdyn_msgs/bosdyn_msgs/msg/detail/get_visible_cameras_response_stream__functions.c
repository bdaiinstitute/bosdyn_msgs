...
bosdyn_msgs__msg__GetVisibleCamerasResponseStream__init(bosdyn_msgs__msg__GetVisibleCamerasResponseStream * msg)
{
  ...
  // window
  if (!bosdyn_msgs__msg__GetVisibleCamerasResponseStreamWindow__init(&msg->window)) {
    bosdyn_msgs__msg__GetVisibleCamerasResponseStream__fini(msg);
    return false;
  }
  // window_is_set
  // camera
...
bosdyn_msgs__msg__GetVisibleCamerasResponseStream__fini(bosdyn_msgs__msg__GetVisibleCamerasResponseStream * msg)
{
  ...
  // window
  bosdyn_msgs__msg__GetVisibleCamerasResponseStreamWindow__fini(&msg->window);
  // window_is_set
  // camera
...
bosdyn_msgs__msg__GetVisibleCamerasResponseStream__are_equal(const bosdyn_msgs__msg__GetVisibleCamerasResponseStream * lhs, const bosdyn_msgs__msg__GetVisibleCamerasResponseStream * rhs)
{
  ...
  // window
  if (!bosdyn_msgs__msg__GetVisibleCamerasResponseStreamWindow__are_equal(
      &(lhs->window), &(rhs->window)))
  {
    return false;
  }
  // window_is_set
  if (lhs->window_is_set != rhs->window_is_set) {
    return false;
  }
  // camera
  ...
  bosdyn_msgs__msg__GetVisibleCamerasResponseStream * output)
{
  ...
  // window_is_set
  output->window_is_set = input->window_is_set;
  // camera
...
bosdyn_msgs__msg__GetVisibleCamerasResponseStream__create()
{
  ...
  bosdyn_msgs__msg__GetVisibleCamerasResponseStream * msg = (bosdyn_msgs__msg__GetVisibleCamerasResponseStream *)allocator.allocate(sizeof(bosdyn_msgs__msg__GetVisibleCamerasResponseStream), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bosdyn_msgs__msg__GetVisibleCamerasResponseStream));
  bool success = bosdyn_msgs__msg__GetVisibleCamerasResponseStream__init(msg);
  if (!success) {
...
bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence__init(bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__GetVisibleCamerasResponseStream * data = NULL;

  if (size) {
    data = (bosdyn_msgs__msg__GetVisibleCamerasResponseStream *)allocator.zero_allocate(size, sizeof(bosdyn_msgs__msg__GetVisibleCamerasResponseStream), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bosdyn_msgs__msg__GetVisibleCamerasResponseStream__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bosdyn_msgs__msg__GetVisibleCamerasResponseStream__fini(&data[i - 1]);
      }
...
bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence__fini(bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bosdyn_msgs__msg__GetVisibleCamerasResponseStream__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence * array = (bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence *)allocator.allocate(sizeof(bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence__init(array, size);
  if (!success) {
...
bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence__destroy(bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence__are_equal(const bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence * lhs, const bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bosdyn_msgs__msg__GetVisibleCamerasResponseStream__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bosdyn_msgs__msg__GetVisibleCamerasResponseStream__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bosdyn_msgs__msg__GetVisibleCamerasResponseStream);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bosdyn_msgs__msg__GetVisibleCamerasResponseStream * data =
      (bosdyn_msgs__msg__GetVisibleCamerasResponseStream *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bosdyn_msgs__msg__GetVisibleCamerasResponseStream__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bosdyn_msgs__msg__GetVisibleCamerasResponseStream__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!bosdyn_msgs__msg__GetVisibleCamerasResponseStream__copy(
