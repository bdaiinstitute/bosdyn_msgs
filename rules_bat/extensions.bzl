...
def _ros_package_repository_impl(repository_ctx):
    ...
    for cc_include in repository_ctx.attr.cc_includes:
        if repository_ctx.path(cc_include).exists:
            cc_includes.append(cc_include)
...
""",
    attrs = dict(
        ...
        cc_includes = attr.string_list(doc = "List of (additional) directories to add to include path.", default=list())
    ),
)
        ...
        for parse in module.tags.parse:
            ...
            for addtl_deb in module.tags.additional_deb:
                ...
                ros_package_repository(
                    ...
                    cc_includes = addtl_deb.cc_includes,
...
_additional_deb_tag = tag_class(
    ...
    attrs = dict(
        ...
        cc_includes = attr.string_list(
            doc = "List of include directories to add to the path"
        )
    ),
)
